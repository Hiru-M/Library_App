...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COLOUMN_TITLE ="book_title";
    public static final String COLOUMN_AUTHOR ="publisher_name";
    ...
    void addBook(String title, String author){
        ...
        cv.put(COLOUMN_TITLE,title);
        cv.put(COLOUMN_AUTHOR,author);
